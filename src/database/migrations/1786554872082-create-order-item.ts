...
export class CreateOrderItem1786554872082 implements MigrationInterface {
    name = 'CreateOrderItem1786554872082'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "order_item" ("quantity" integer NOT NULL, "price" numeric(4,2) NOT NULL, "orderId" integer NOT NULL, "productId" integer NOT NULL, CONSTRAINT "PK_7e383dc486afc7800bf87d1c11a" PRIMARY KEY ("orderId", "productId"))`);
